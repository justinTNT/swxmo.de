		...
		if ( !eventHandle ) {
			elemData.handle = eventHandle = function( e ) {
				...
				if (typeof e.type === 'undefined')
					return undefined;
				if (e.type === jQuery.event.triggered)
					return undefined;
...
var swxmodeskeleta = JSON.parse('{"listthis.htm":"<div class=\'eachfield\'>  <div class=\'name\'></div> </div> ","login.htm":"<form action=\'/sessions\' method=\'post\'> Login: <input id=\'login\' name=\'login\'></input><br> Password: <input id=\'password\' name=\'password\' type=\'password\'></input><br> <input type=\'submit\' value=\'Login\' /> </form> ","listall.htm":"<div class=\'listallschemes\'>  <p>  Select the scheme to manage:  </p>  <div class=\'eachtable\'>  <a class=\'table\'></a>  </div> </div> "}');
if (typeof $ == 'undefined') {
